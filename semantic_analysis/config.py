...
if USE_PROXY:
    ...
    proxies = {
        #          [协议]://  [地址]  :[端口]
        "http":  "http://127.0.0.1:10809",  # 再例如  "http":  "http://127.0.0.1:7890",
        "https": "http://127.0.0.1:10809",  # 再例如  "https": "http://127.0.0.1:7890",
    }
else:
    proxies = None
...
AVAIL_LLM_MODELS = ["gpt-3.5-turbo-1106","gpt-4-1106-preview","gpt-4-vision-preview",
                    "gpt-3.5-turbo-16k", "gpt-3.5-turbo","gpt-4o-mini", "azure-gpt-3.5",
